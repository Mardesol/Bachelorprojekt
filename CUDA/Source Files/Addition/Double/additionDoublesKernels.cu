...
__global__ void Sequential(double *M1, double *M2, double *M3, int rows, int cols)
{
...
__global__ void Parallel(double *M1, double *M2, double *M3, int rows, int cols)
{
...
__global__ void SharedMemory(double *M1, double *M2, double *M3, int rows, int cols)
{
    int row = blockIdx.y * blockDim.y + threadIdx.y;
    int col = blockIdx.x * blockDim.x + threadIdx.x;
