...
const char* executeChosenKernel(int KernelNumToPerform, double* device_M1, double* device_M2, double* device_M3, int M1Rows, int M1Cols, int M2Cols, Timer timer)
{
    dim3 blockDim(32, 32);
...
int main(int argc, char *argv[])
{
    ...
    size_t memorySize1 = M1Rows * M1Cols * sizeof(double);
	size_t memorySize2 = M2Rows * M2Cols * sizeof(double);
	size_t memorySize3 = M3Rows * M3Cols * sizeof(double);
    ...
    multiplicationDoubles(M1, M2, MCPU);
