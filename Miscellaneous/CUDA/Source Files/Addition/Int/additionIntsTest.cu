...
float measureKernelExecutionTime(
    ...
    int *M1, int *M2, int *M3, int MRows, int MCols,
...
int main(int argc, char* argv[])
{
    ...
    sprintf(fileName, "Test/Int_Execution_Times_Matrix_Size_%dx%d.csv", MRows, MCols);  // Customize filename to reflect size of result matrix
